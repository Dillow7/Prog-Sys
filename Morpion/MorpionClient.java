...
public class MorpionClient extends JFrame {
    ...
    private static final Color COULEUR_FOND = new Color(248, 248, 248);
    private static final Color COULEUR_TEXTE = Color.BLACK;
    private static final Font POLICE_JEU = new Font("Arial", Font.BOLD, 60);
    ...
    public MorpionClient() {
        ...
        zoneChat.setBackground(Color.WHITE);
